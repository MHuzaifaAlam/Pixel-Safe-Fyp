import { i as __toESM, n as __commonJS, t as require_react } from "./react-D-F4Gh-6.js";
import { t as require_react_dom } from "./react-dom-D-I-6tNd.js";

//#region node_modules/react-router/dist/development/chunk-UIGDSWPH.mjs
...
function createRouter(init) {
	...
	async function handleFetcherAction(key, routeId, path, requestMatches, scopedContext, isFogOfWar, flushSync, preventScrollReset, submission) {
		...
		let actionResult = (await callDataStrategy(fetchRequest, getTargetedDataStrategyMatches(mapRouteProperties2, manifest, fetchRequest, requestMatches, match, hydrationRouteProperties2, scopedContext), scopedContext, key))[match.route.id];
...
try {
	if (isBrowser) window.__reactRouterVersion = "7.9.5";
} catch (e) {}
...
//#endregion
//#region node_modules/react-router/dist/development/chunk-JG3XND5A.mjs
